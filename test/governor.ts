...
describe("Governor.sol", function () {
  ...
  it("should pack a request into bytes", async function () {
    ...
    // !! packed is a hex string
    expect(packed).to.hexEqual(
      ""
    );
  });
});
