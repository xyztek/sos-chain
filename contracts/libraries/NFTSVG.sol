...
library NFTSVG {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    generateSVGCardMantle(params.tokenSymbol),
    ...
    function generateSVGCardMantle(string memory tokenSymbol)
        private
        pure
        returns (string memory svg)
    {
    ...
    function generateSVGPositionDataAndLocationCurve(
        ...
        uint256 str2length = bytes(organization).length + 14;
        uint256 str3length = bytes(cause).length + 7;
        ...
        svg = string(
            abi.encodePacked(
                ...
                'px" height="26px" rx="8px" ry="8px" fill="rgba(0,0,0,0.6)" />',
                '<text x="12px" y="17px" font-family="\'Courier New\', monospace" font-size="12px" fill="white"><tspan fill="rgba(255,255,255,0.6)"> Organization: </tspan>',
                organization,
                "</text></g>",
                ...
                'px" height="26px" rx="8px" ry="8px" fill="rgba(0,0,0,0.6)" />',
                '<text x="12px" y="17px" font-family="\'Courier New\', monospace" font-size="12px" fill="white"><tspan fill="rgba(255,255,255,0.6)"> Cause: </tspan>',
                cause,
                "</text></g>"
